...
class ShoppingBagWidget extends StatelessWidget {
  ...
  Future<void> _goOrder(BuildContext context) async {
    ...
    //envia para o order
    var updateBag = await navigator.pushNamed('/order', arguments: bag);
    controller.updateBag(updateBag
        as List<OrderProductDto>); //retorna um dynamic e precisa fazer um cast
  }
